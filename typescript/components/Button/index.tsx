...
export default function Button({ active, disabled, className = "", iconOnly, beforeContent, afterContent, size, variant = "primary", color = "primary", children, ...props }: ButtonProps) {
  return (
    <button
