 ...
 * - `onSubmit`: function - Function to call when the submit button is clicked.
 * - `onCancel`: function (optional) - Function to call when the cancel button is clicked.
...
export default function Modal({ visible, text, submitText, onSubmit, onCancel, className, children, ...props }) {
  return createPortal(
    <AnimatePresence>
      {visible && (
        <motion.div
